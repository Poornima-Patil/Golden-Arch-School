...
<head>
	...
	<title>Activity - Golden Arch Montessori School</title>
	...
	<div id="wrapper">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 slide">
						...
						<p>Apart from working with the Montessori material, loads of exploratory activities are given to consolidate their concepts. All these activities are planned based on the multiple intelligence structure.</p>
					</div>
				</div>
			</div>
		</section>
		<section id="content">
			<div class="container">
				<div class="row">
					<div class="col-lg-8">
						<strong class="title">Little Speaker Day</strong>
						<p>Childrens are given an opportunity to speak about topics which are announced in advance</p>
						<strong class="title">Themes for the month</strong>
						<p>Each  month revolves around a theme. Eg., Seasons, water, sports etc..</p>
						<strong class="title">Sound Days</strong>
						<p>We encourage the child to bring objects starting with the sound of the day</p>
						<strong class="title">Color Day</strong>
						<p>These days become colorful for Golden Arch as the children and the Teachers wear the color of the day</p>
						<ul>
							<li>Experiments</li>
						...
						<p>Activities of various kinds are performed to ensure learning  and fun for children.</p>
						<ul>
							<li>Music &ndash; Mr. Merwin the guitarist visits us to teach and  enthrall the children.</li>
							<li>Art Professionals too visit us as scheduled for Art and  Craft activities.</li>
						</ul>
					</div>
					...
					<div class="col-lg-4">
						<aside class="right-sidebar">
							<div class="widget">
								<div class="img"><img src="upload/activity/activity-1.gif" alt="Out Activities"></div>
							</div>
						</aside>
					</div>
