...
<head>
	...
	<title>Our Team - Golden Arch Montessori School</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 slide">
						<h1>Our Team</h1>
						<div align="center"><img src="images2018/ourteam.jpg" width="500" height="333" alt="OUR TEAM" /></div>
						<h3 align="center">"Nothing can be more earnest, dedicated and commited than <strong>OUR TEAM</strong>"</h3>
					</div>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<ul class="listing">
							<li>
								<img src="images2018/anupama eswar.jpg" width="154" height="150" alt="Mrs. Anupama Eswar">
								<strong>Mrs. Anupama Eswar - Director</strong><br />
								Golden Arch is &lsquo;My Child&rsquo; and I promise to exert to keep up the essence of education through out my life.
								<div class="clear"></div>
							</li>
							<li>
								<img src="images2018/girija.jpg" width="154" height="150" alt="Mrs. Girija">
								<strong>Mrs. Girija &ndash; Academic Co-ordinator</strong><br />
								<strong>She has completed her Montessori Training from the IMTC. Multiskilled and an extremely committed individual. Is here since 8 years.</strong><br />
							...
							<li>
								<img src="images2018/anjana.jpg" width="154" height="150" alt="Mrs. Anjana">
								<strong>Mrs. Anjana</strong><br />
								<strong>Montessori Trained from IMTC, Very cheerful and extremely caring.</strong><br />
								&quot;It is my pleasure to be part of this Golden Arch Group. I can rightly call it Home away from Home for the tiny tots.&quot;
								<div class="clear"></div>
							</li>
							<li>
								<img src="images2018/shilpa.jpg" width="154" height="150" alt="Mrs. Shilpa">
								<strong>Mrs. Shilpa</strong><br />
								<strong>Montessori Trained from IMTC, with 7 yrs of experience in working with Children.</strong><br />
							...
							<li>
								<img src="images2018/aarthi.jpg" width="154" height="150" alt="Mrs. Aarthi">
								<strong>Mrs. Aarthi</strong><strong><br />
								<strong>Montessori Trained from IMTC, Soft Spoken and cheerful.</strong><br />
								&quot;Very conducive environment for children to learn. This is the right place to experience Montessori system at its best&quot;
								<div class="clear"></div>
							</li>
							<li>
								<img src="images2018/g11.jpg" width="154" height="190" alt="Mrs Ramya">
								<strong>Mrs Ramya</strong><br />
								<strong>Pre Montessori and Day Care In charge</strong><br />
								&quot;She is very calm, patient and very efficient in handling children of all age groups. She is with us since 3 years. &quot; 
								<div class="clear"></div>
							</li>
							<li>
								<img src="images2018/sumona.jpg" width="154" height="150" alt="Mrs. Sumona">
								<strong>Mrs. Sumona</strong><br />
								<strong>Bachelor in Education Incharge for Elementary</strong><br />
								&quot;She works to Precision and creative. Is with Golden Arch for 4 years. 
								"Golden Arch is a family to me and I feel at home" &quot;
								<div class="clear"></div>
							</li>
							<li>
								<img src="images2018/saroja.jpg" width="154" height="150" alt="Mrs. Saroja">
								<strong>Mrs. Saroja</strong><br />
								<strong>Support Teacher for Preprimary.</strong><br />
								&quot;Hard working and an Achiever. With us for 2 years. " Management is truly committed to give Montessori method at it's best" &quot;
								<div class="clear"></div>
							</li>
							<li>
								<img src="images2018/tejeshwini.jpg" width="154" height="150" alt="Mrs. Tejeshwini">
								<strong>Mrs. Tejeshwini</strong><br />
								<strong>Support Teacher for Pre Primary</strong><br />
							...
							<li>
								<strong>Mrs Ramya Karthik</strong><br />
								<strong>Elementary Incharge</strong><br />
							...
							<li>
								<img src="images2018/amitha.jpg" width="154" height="150" alt="Mrs Amitha">
								<strong>Mrs Amitha</strong><br />
								<strong>Support Teacher</strong><br />
								&quot;Expressive and Charming. Is at Golden Arch for a year. " I love Golden Arch the best, of all workplaces" &quot; 
								<div class="clear"></div>
							</li>
							<li>
								<img src="images2018/jeena.jpg" width="154" height="150" alt="Mrs. Jeena">
								<strong>Mrs. Jeena</strong><br />
								<strong>Elementary support Teacher</strong><br />
