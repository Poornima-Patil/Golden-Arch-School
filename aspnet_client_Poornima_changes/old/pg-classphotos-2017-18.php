...
<head>
	...
	<title>Photo Gallery - CLASS GROUP PHOTOS 2017-18 - Golden Arch Montessori School</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 slide">
						<h1>Photo Gallery - CLASS GROUP PHOTOS</h1>
					</div>
				</div>
			</div>
		</section>
				...
				<div class="row">
					<div class="col-lg-12">   
						...
						<div id="grid-container" class="cbp-l-grid-projects">
							<ul>
								<li class="cbp-item">
									<div align="center"><img src="classphotos/CORALREEF.jpg" width="100%" height="100%" class="img" /></div>	
								</li>
								<li class="cbp-item">
									<div align="center"><img src="classphotos/NEST.jpg" width="100%" height="100%" class="img" /></div>
								</li>
								<li class="cbp-item">
									<div align="center"><img src="classphotos/OASIS.jpg" width="100%" height="100%" class="img" /></div>
								</li>
								<li class="cbp-item">
									<div align="center"><img src="classphotos/ORCHARD.jpg" width="100%" height="100%" class="img" /></div>
								</li>
								<li class="cbp-item">
									<div align="center"><img src="classphotos/RAINBOW.jpg" width="100%" height="100%" class="img" /></div>
								</li>
								<li class="cbp-item">
									<div align="center"><img src="classphotos/CASTLE.jpg" width="100%" height="100%" class="img" /></div>
								</li>
								<li class="cbp-item">
									<div align="center"><img src="classphotos/TEAM.jpg" width="100%" height="100%" class="img" /></div>
								</li>
							</ul>
						</div>
						<!-- -->
