...
<head>
	...
	<title>Montessori Activities - Golden Arch Montessori</title>
	...
	<div id="wrapper">
		...
		<section id="content">
			<div class="container">
				<div class="row">
					<div class="col-lg-8">
						<h3 class="title">LEP</h3>
						<p>Language enrichment program by Stones to Milestones. Contact - Snehal : 9731722533 / 8762660120</p>
						<ul>
							<li><h3 class="title">Tuition Classes up to 10<sup>th</sup> Grade</h3></li>
						</ul>
						<h3 class="title">Sanskriti</h3>
						<p class="title">A cultural offshoot of Golden Arch which offers the following classes  <a href="contact-us.php">Contact</a></p>
						<p><strong>Tabla</strong><br/>
						By - Srikant.g.Devipur, M.A. Disciple of Dr. Zakir Hussain <a href="contact-us.php">Contact</a><br />
						Contact - 9448619860</p>
						<p><strong>Art</strong><br/>
						By - Shomi Banerjee, Artist from Bengal School of Arts <a href="contact-us.php">Contact</a><br />
						Contact - 9538235971</p>
						<p><strong>Karate</strong><br/>
						Contact - 8892032917 <a href="contact-us.php">Contact</a></p>
						<p><strong>Dance - Bharathnatyam</strong><br/>
						By - Asha.K.Bhat, Bharathnatyam Senior <a href="contact-us.php">Contact</a><br />
						Contact - 9901964655</p>
						<p><strong>Music - Piano</strong><br/>
						By - Merwin P Menezes, Musician and Composer <a href="contact-us.php">Contact</a><br />
						Contact - 9663069400</p>
						<p><strong>Cub's corner </strong><br/>
						The Children's Library</p>
					</div>

					<div class="col-lg-4">
						<aside class="right-sidebar">
							<div class="widget">
								<div class="img"><img src="images1/after-school-activity.gif" width="380" height="357" alt="After School Activity"></div>
							</div>
						</aside>
					</div>
