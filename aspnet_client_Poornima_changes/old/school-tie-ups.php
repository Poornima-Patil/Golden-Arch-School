...
<head>
	...
	<title>School Tie Ups - Golden Arch Montessori School</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 slide">
						<h1>School Tie Ups</h1>
						<h2>We have tie-ups with the following schools for smooth transition to grade <span style="font-family:'Times New Roman', Times, serif;">I</span> after Montessori education.</h2>
					</div>
				</div>
			</div>
		</section>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div id="grid-container" class="cbp-l-grid-projects">
							<ul>
								<li class="cbp-item">
									<div align="center"><img src="upload/cambridge.jpg" width="200" height="200" alt="cambridge Public School"></div>	
								</li>
								<li class="cbp-item">
									<div align="center"><img src="upload/india.jpg" width="200" height="200" alt="India International School"></div>
								</li>
								<li class="cbp-item" style="height:260px;">
									<div align="center"><img src="upload/lawrence.jpg" width="200" height="200" alt="Lawrence School" /></div>
								</li>
								<li class="cbp-item" style="height:260px;">
									<div align="center"><img src="upload/zee.jpg" width="200" height="200" alt="Zee School"></div>
								</li>
								<li class="cbp-item" style="height:260px;">
									<div align="center"><img src="upload/vib.jpg" width="200" height="200" alt="vibgyor" /></div>
								</li>
								<li class="cbp-item" style="height:260px;">
									<div align="center"><img src="upload/logo1.gif" width="200" height="200" alt="vibgyor" /></div>
								</li>
								<li class="cbp-item" style="height:260px;">
									<div align="center"><img src="upload/logo2.gif" width="200" height="200" alt="vibgyor" /></div>
								</li>
								<li class="cbp-item" style="height:260px;">
									<div align="center"><img src="upload/logorcis.jpg" width="200" height="180" alt="vibgyor" /></div>
								</li>
							</ul>
						</div>
