...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="100%" border="0" align="center" style="border:1px solid;">
    ...
    <tr>
      <td style="padding-left:50px;"><strong>Team Name: </strong></td>
      <td><label> 
        <input type="text" size="85" name="teamname"  id="ntitle"/>
        </label></td>
    </tr>
    <tr>
      <td valign="top" style="padding-left:50px;"><br/><strong>Team Description: </strong></td>
      <td><label> <br/>
        <!--textarea class="teamdiscription" name="teamdiscription" cols="37" rows="5"></textarea-->
		<?php
		$ctrl_name = 'teamdiscription';
		$sBasePath = 'fckeditor/';
...
if (isset($_POST['save'])) 
		{
			$tn=$_POST['teamname'];
			$td=$_POST['teamdiscription'];
				$ins="insert into ga_team(Tmem_name,Tmem_description) values('$tn','$td')";
				mysql_query($ins);
		}	?>
		...
		<td><strong>Team Feedback</strong></td>
		...
		<td style="padding-center:200px" ><div style="float:left;margin-right:20px; font:18px bold;"><?php echo $row['Tmem_name']; ?><div/></td>
		<td>  <div style="float:left;margin-right:10px;font:20px bold;"><?php echo $row['Tmem_description']; ?></div> </td>
		<td><a href="team.php?del_id=<?php echo $row['Tmem_id']; ?>" onClick="if(confirm('Are you sure you want to delete this record.')){ return true; }else { return false; }">Delete</a></td>
		</tr>
		<?php
		$i++;
		}
